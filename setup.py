...
setup(
    name='releasetool',
    version='0.0.1',
    description='release wrapper using ansible',
    long_description=get_long_description(),
    long_description_content_type='text/markdown',
    url='https://github.com/theforeman/releasetool',
    ...
    package_data={
        'releasetool': find_package_data('releasetool', 'data'),
    },

    entry_points={
        'console_scripts': [
            'releasetool=releasetool:main',
        ],
    },
)
